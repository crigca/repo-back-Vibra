...
const artistsByGenre = {
  ...
  "bachata": ["Romeo Santos","Aventura","Prince Royce","Juan Luis Guerra","Zacarías Ferreira","Joe Veras","Antony Santos","Frank Reyes","Luis Vargas","Andy Andy","Yoskar Sarante","El Torito (Héctor Acosta)","Kiko Rodríguez","Monchy & Alexandra","Teodoro Reyes","Raulín Rodríguez","Ramón Cordero","Leonardo Paniagua","Blas Durán","Grupo Extra","Toby Love","Andy Lucas"],
  "balada": ["José José","Rocío Dúrcal","Camilo Sesto","Juan Gabriel","Cristian Castro","Laura Pausini","Alejandro Sanz","Ana Gabriel","Ricardo Montaner","Yuri","Mijares","Chayanne","Emmanuel","Sandro","Myriam Hernández","Pablo Alborán","David Bisbal","Carlos Rivera","Silvina Garré","Dany Martin","Marcela Morelo","Pimpinela","Marco Antonio Solís"],
  ...
  "bluesRock": ["Javier Martínez (Manal)","Billy Gibbons","Rory Gallagher","Jimi Hendrix","Stevie Ray Vaughan","The Allman Brothers Band","ZZ Top","Cream","Gary Moore","The Black Keys","Derek and the Dominos","Gary Clark Jr.","John Mayer","Gov't Mule","Bonnie Raitt","Beth Hart","Tedeschi Trucks Band","Humble Pie","The Jeff Beck Group","The Jimi Hendrix Experience"],
  "bolero": ["Trío Los Panchos","Armando Manzanero","Antonio Machín","José Feliciano","Lucho Gatica","Julio Jaramillo","Los Tres Reyes","Daniel Santos","Olga Guillot","Marco Antonio Muñiz","Bienvenido Granda","Alfredo Sadel","Alberto Cortez","Pablo Milanés","Vicente Garrido","Chavela Vargas","Eydie Gormé","Bobby Capó","Ibrahim Ferrer"],
  ...
  "country": ["Johnny Cash","Dolly Parton","Garth Brooks","Shania Twain","Carrie Underwood","Willie Nelson","Luke Bryan","Kacey Musgraves","Blake Shelton","George Strait","Reba McEntire","Hank Williams","Loretta Lynn","Kenny Rogers","Alan Jackson","Tim McGraw","Faith Hill","Keith Urban","Miranda Lambert","Chris Stapleton","Patsy Cline","Merle Haggard","Toby Keith"],
  "clasica": ["Jacques Offenbach","Johann Sebastian Bach","Wolfgang Amadeus Mozart","Ludwig van Beethoven","Pyotr Ilyich Tchaikovsky","Giuseppe Verdi","Richard Wagner","Frédéric Chopin","Franz Schubert","Antonio Vivaldi","Johannes Brahms","Claude Debussy","Igor Stravinsky","Sergei Rachmaninoff","Gustav Mahler","Franz Liszt","Robert Schumann","George Frideric Handel","Maurice Ravel","Camille Saint-Saëns","Antonín Dvořák","Gustav Holst","Hector Berlioz","Modest Mussorgsky","Erik Satie"],
  ...
  "cumbia": ["Los Ángeles Azules","La Sonora Dinamita","Los Palmeras","Ráfaga","Gilda","La Nueva Luna","Los Charros","Karicia","Los Mirlos","Lucho Bermúdez","Pastor López","Antonio Ríos","Selva Negra","Agapornis","Mar Azul","Los Totora","Leo Mattioli","Rodrigo Tapari","La Delio Valdez","Damas Gratis","La T y La M","Malandro","Ke Personajes","Renzo ED","Elaggume","El Pepo","Angela Leiva","Onda Sabanera","Fer Palacio","Grupo 5","Migrantes","Rombai","Maramá","Grupo Niche","Conjunto Mar Azul"],
  ...
  "cumbiaVillera": ["Damas Gratis","Pibes Chorros","Yerba Brava","Mala Fama","Meta Guacha","Amar Azul","Supermerk2","Los Gedes","Flor de Piedra","La Base","La Liga","El Empuje","La Champions Liga","Los del Fuego","Agrupación Marilyn","Altos Cumbieros","Los Nota Lokos","El Polaco","Sebastián Mendoza","El Original","Los Peñaloza","Rocío Quiroz","Pablito HC"],
  "cuarteto": ["Carlos 'La Mona' Jiménez","Rodrigo","Ulises Bueno","La Barra","Damián Córdoba","El Rey Pelusa","Walter Olmos","Banda XXI","El Loco Amato","Sebastián","Tru-la-lá","Chebere","Gary","La Konga","Q' Lokura","Magui Olave","Monada","Jean Carlos","La Fiesta","La T y La M","Luck Ra"],
  ...
  "disco": ["Bee Gees","Donna Summer","Gloria Gaynor","Chic","KC and the Sunshine Band","Village People","Diana Ross","Barry White","Sylvester","The Trammps","ABBA","Sister Sledge","Boney M.","The Jacksons","Hot Chocolate","Amii Stewart","Evelyn 'Champagne' King","Tavares","Patrick Hernandez","The Emotions","Scissor Sisters"],
  ...
  "edm": ["The Chainsmokers","Kygo","Porter Robinson","Subtronics","Martin Garrix","Calvin Harris","David Guetta","Zedd","Marshmello","Alan Walker","Avicii","Tiesto","Hardwell","Alesso","Swedish House Mafia","Afrojack","Steve Aoki","Dimitri Vegas & Like Mike","KSHMR","Don Diablo"],
  "electronic": ["Daft Punk","The Chemical Brothers","Kraftwerk","Aphex Twin","Underworld","Moby","Boards of Canada","Fatboy Slim","The Prodigy","Orbital","Röyksopp","Justice","Caribou","Bonobo","Four Tet","Jon Hopkins","Burial","Jamie xx","Moderat","Nicolas Jaar"],
  "edmActual": ["Martin Garrix","Marshmello","The Chainsmokers","Alan Walker","Zedd","Kygo","Illenium","Madeon","Porter Robinson","Steve Aoki","Hardwell","Oliver Heldens","Alesso","Afrojack","Don Diablo","Dimitri Vegas & Like Mike","David Guetta","Armin van Buuren","Peggy Gou","Diplo","Mark Ronson"],
  ...
  "flamenco": ["Paco de Lucía","Camarón de la Isla","Vicente Amigo","Tomatito","Niño Josele","Diego el Cigala","Niña Pastori"],
  ...
  "funkRap": ["Illya Kuryaki & the Valderramas","Emmanuel Horvilleur","Jugo","Lo Pibitos","Anderson .Paak","Childish Gambino","Mac Miller","Tyler The Creator","Chance the Rapper","A Tribe Called Quest","The Roots","Dr. Dre","Warren G","Nate Dogg","DJ Quik","Faith No More","Living Colour"],
  ...
  "hardcorePunk": ["Black Flag","Minor Threat","Bad Brains","Dead Kennedys","Agnostic Front","Circle Jerks","Madball","Gorilla Biscuits"],
  "heavyMetal": ["Iron Maiden","Judas Priest","Black Sabbath","Helloween","Manowar","Saxon","Accept","Van Halen","Whitesnake","Dio","Motörhead","Scorpions","Pantera","Metal Church","Yngwie Malmsteen","Stratovarius","Gamma Ray","Iced Earth","Primal Fear","DragonForce","Angra","Nightwish","Slipknot","MESHUGGAH","Sabaton","Ratos de Porão"],
  ...
  "hiphop": ["Kendrick Lamar","Drake","J. Cole","Jay-Z","Kanye West","Travis Scott","Nicki Minaj","Cardi B","Wu-Tang Clan","Big Daddy Kane","Ice-T","EPMD","MC Hammer","Tyler, The Creator","A$AP Rocky","Run-DMC","LL Cool J","Rakim","Ice Cube","Public Enemy","Outkast","N.W.A.","Lil Wayne","Nas","50 Cent","ASD","Afrob","Samy Deluxe","Grandmaster Flash","The Notorious B.I.G.","DJ Khaled","Xavier Wulf","Mr. Pookie","Zach Mc Phee"],
  ...
  "indieRock": ["The Strokes","Arctic Monkeys","Vampire Weekend","Franz Ferdinand","The National","Kings of Leon","Tame Impala","Interpol","The White Stripes","Yeah Yeah Yeahs","MGMT","Modest Mouse","The Libertines","Arcade Fire","Phoenix","Two Door Cinema Club","Bloc Party","Foals","The Shins","The Kooks","Death Cab for Cutie","The War on Drugs","Vance Joy","Wet Leg"],
  ...
  "infantil": ["Canticuénticos","Magdalena Fleitas","Los Raviolis","Pim Pau","Topa","Plim Plim","Leoncito Alado","Ocho Monitos Canciones Infantiles","A Ram Sam Sam Canciones Infantiles","Un Piojito Canciones Infantiles","Veo Veo Canciones Infantiles","A Bañarme Canciones Infantiles","El Cangrejo No Es Un Pez Canciones Infantiles"],
  ...
  "jazz": ["Miles Davis","John Coltrane","Louis Armstrong","Duke Ellington","Ella Fitzgerald","Charlie Parker","Billie Holiday","Thelonious Monk","Herbie Hancock","Chet Baker","Sarah Vaughan","Sonny Rollins","Charles Mingus","Dizzy Gillespie","Stan Getz","Wynton Marsalis","Ornette Coleman","Chick Corea","Pat Metheny","Esperanza Spalding","Crazy Macayas Trio","Frank Sinatra","Roxana Amed","Yamile Burich","Hernán Jacinto","Ricardo Lew","Ligia Piro","ARGENTUM Jazz Quinteto","Bourbon Sweethearts","Escalandrum","Swing Summit Trío","Trío Sin Tiempo"],
  ...
  "kpop": ["BTS","BLACKPINK","EXO","TWICE","Red Velvet","Stray Kids","SEVENTEEN","NCT 127","ITZY","AESPA","GOT7","TXT","BigBang","Girls' Generation","Super Junior","2NE1","SHINee","LE SSERAFIM","NewJeans","IVE","NAYEON","JYP Entertainment"],
  "latinIndie": ["Zoé","Porter","Siddhartha","Bomba Estéreo","Carla Morrison","Mon Laferte","Hello Seahorse!","Los Amigos Invisibles","El Mató a un Policía Motorizado","Gepe","Dënver","Natalia Lafourcade","Pezcuis","Ainda","Bandalos Chinos","Ca7riel y Paco Amoroso","Feli Colina","Dillom","Julieta Venegas","Ximena Sariñana"],
  ...
  "mariachi": ["José Alfredo Jiménez","Pedro Infante","Alejandro Fernández","Aida Cuevas","Lucha Villa","Javier Solís","Flor Silvestre","Antonio Aguilar","Pepe Aguilar","Amalia Mendoza","Juan Valentín","Mariachi Vargas de Tecalitlán","Mariachi Sol de México","Mariachi Cobre","Christian Nodal","Lucero","Lupita D'Alessio"],
  ...
  "musicaBrasilera": ["Caetano Veloso","Gilberto Gil","Gal Costa","Chico Buarque","Elis Regina","Milton Nascimento","Jorge Ben Jor","Tom Jobim","João Gilberto","Djavan","Maria Bethânia","Ivete Sangalo","Marisa Monte","Zeca Pagodinho","Seu Jorge","Legião Urbana","Os Mutantes","Sepultura","Anitta","Luan Santana","Rita Lee","Robinio Mundibu"],
  "newWave": ["Duran Duran","A-ha","Tears for Fears","Eurythmics","INXS","Simple Minds","Talking Heads","The B-52's","The Human League","Ultravox","Joy Division"],
  ...
  "pop": ["Michael Jackson","Madonna","Prince","Whitney Houston","Mariah Carey","Janet Jackson","Taylor Swift","Dua Lipa","Ariana Grande","Katy Perry","Lady Gaga","Britney Spears","Christina Aguilera","Ed Sheeran","Bruno Mars","Justin Bieber","Selena Gomez","Shawn Mendes","Billie Eilish","Harry Styles","Olivia Rodrigo","Miranda!","Benny Blanco","Sabrina Carpenter","Post Malone","Doja Cat","Bandana","Adele","Crazy Frog","Seal","The Beach Boys","Lana Del Rey","Björk","Rosalía","Sam Smith","Zoe Gotusso","El Kuelgue","Usted Señálemelo","Denise Rosenthal","Francisca Valenzuela","Camila","Violette Wautier","Maroon 5","Lizzo","La Oreja de Van Gogh","Fergie","The Black Eyed Peas","Las Ketchup"],
  ...
  "popLatinoActual": ["Sebastián Yatra","Morat","Tini","Kany García","Carlos Rivera","Fonseca","Sin Bandera","Jesse & Joy","Camilo","Anahí","Maite Perroni","Samo","Leonel García","Lali","Fanny Lu","Sharon Corr (colab latinas)","Emilia","Valentino Merlo","Natti Natasha","CNCO","Piso 21","Greeicy","Gloria Trevi","Pedro Capó","Alex Ubago","Axel","Danny Ocean","Alvaro Soler"],
  "popLatinoClasico": ["Luis Miguel","Ricky Martin","Gloria Estefan","Shakira","Enrique Iglesias","Thalía","Paulina Rubio","Chayanne","Alejandro Sanz","Laura Pausini","Ricardo Arjona","Cristian Castro","Marc Anthony","Juanes","Belinda","Natalia Lafourcade","David Bisbal","Reik","Ha*Ash","Camila","Fey","Kabah","OV7","Paty Cantú","Mecano","Hombres G","Vanessa Martín","Pablo Alborán","Axel","Pedro Capó","Coti","Amaia Montero","Eros Ramazzotti (colab en español)","Rosana","Ednita Nazario","Soledad Pastorutti (pop/folk fusión)","Miguel Bosé"],
  "popPunk": ["Blink-182","Green Day","Paramore","My Chemical Romance","Sum 41","Avril Lavigne","Fall Out Boy","Good Charlotte","Simple Plan","All Time Low","New Found Glory","Jimmy Eat World","Saves The Day","Bowling For Soup","Neck Deep","The Wonder Years","State Champs"],
  ...
  "punk": ["Ramones","Sex Pistols","The Clash","Dead Kennedys","Misfits","Buzzcocks","The Damned","Black Flag","Bad Religion","Descendents","NOFX","Rancid","Green Day","The Offspring","Pennywise","Anti-Flag","Dropkick Murphys","The Exploited","Lagwagon","Fugazi","Blink-182"],
  "ranchera": ["Javier Solís","Lucha Villa","Pedro Infante","Pepe Aguilar","Amalia Mendoza","Antonio Aguilar","Vicente Fernández","Chavela Vargas","José Alfredo Jiménez","Cuco Sánchez","Aida Cuevas","Jorge Negrete","Lola Beltrán","Ana Gabriel","Alejandro Fernández","Pedro Fernández","Lucero","Marco Antonio Solís","Juan Gabriel","Joan Sebastian"],
  "rap": ["Eminem","Nas","Tupac","The Notorious B.I.G.","Lil Wayne","Ice Cube","Run-DMC","Rakim","Snoop Dogg","Jay-Z","Big L","DMX","J. Cole","Kendrick Lamar","Busta Rhymes","Big Pun","KRS-One","Tech N9ne","Killer Mike","Mos Def","Emanero","Nuco","Charlie Ray","Twisted Insane","2Pac"],
  "rb": ["Beyoncé","Rihanna","Usher","Alicia Keys","The Weeknd","Chris Brown","Mary J. Blige","SZA","Frank Ocean","Miguel","Ne-Yo","Trey Songz","Ciara","Brandy","Monica","Toni Braxton","Boyz II Men","Tyrese","Janelle Monáe","H.E.R.","Gnarls Barkley","Jesse Baez","Daniel Caesar"],
  "reggae": ["Bob Marley","Peter Tosh","Jimmy Cliff","Burning Spear","Toots & The Maytals","Ziggy Marley","Damian Marley","Gregory Isaacs","Steel Pulse","Black Uhuru","Dennis Brown","Buju Banton","Chronixx","Protoje","Alborosie","Capleton","Yellowman","Sizzla"],
  ...
  "rock": ["The Beatles","The Rolling Stones","Led Zeppelin","KISS","Santana","Creedence Clearwater Revival","Pink Floyd","Queen","The Who","AC/DC","Guns N' Roses","Aerosmith","U2","The Doors","Deep Purple","Bon Jovi","Pearl Jam","Radiohead","Coldplay","The Police","Dire Straits","Red Hot Chili Peppers","Chuck Berry","Little Richard","Buddy Holly","Elvis Presley","The Kinks","Van Morrison","Janis Joplin","Stevie Nicks","Alex Angel","Alanis Morissette"],
  "rockArgentino": ["Soda Stereo","Charly García","Luis Alberto Spinetta","Fito Páez","Patricio Rey y sus Redonditos de Ricota","Los Redondos","Andrés Calamaro","Los Fabulosos Cadillacs","Divididos","Babasónicos","Los Auténticos Decadentes","Los Pericos","La Renga","Bersuit Vergarabat","Los Enanitos Verdes","Virus","Sumo","Los Tipitos","Catupecu Machu","Attaque 77","León Gieco","Pedro Aznar","David Lebón","Serú Girán","Los Abuelos de la Nada","Ratones Paranoicos","Todos Tus Muertos","Kapanga","Massacre","Carajo","Árbol","Eterna Inocencia","Gustavo Cerati","Eruca Sativa","Los Espíritus","Hilda Lizarazu","Marilina Bertoldi","Conociendo Rusia","Los Piojos","Almendra","Pappo","Vox Dei","Color Humano","Billy Bond","Invisible","Manal","Arco Iris","Superuva","Sui Generis","Estelares","Dante Spinetta","Gustavo Cordera","Mancha de Rolando","Sueños Innatos"],
  "rockLatino": ["Maná","Soda Stereo","Caifanes","Los Fabulosos Cadillacs","Molotov","Héroes del Silencio","Enanitos Verdes","Aterciopelados","Los Prisioneros","Café Tacuba","La Ley","Fito Páez","Charly García","Andrés Calamaro","Bersuit Vergarabat","La Renga","Divididos","Los Auténticos Decadentes","Los Bunkers","Vicentico","La Vela Puerca"],
  "salsa": ["Celia Cruz","Héctor Lavoe","Rubén Blades","Marc Anthony","Willie Colón","Oscar D'León","Tito Puente","Johnny Pacheco","Ismael Rivera","Ray Barretto","Cheo Feliciano","Eddie Palmieri","Larry Harlow","Pete 'El Conde' Rodríguez","Adalberto Santiago","Charlie Palmieri","Frankie Ruiz","La India","Víctor Manuelle","Gilberto Santa Rosa","El Gran Combo de Puerto Rico"],
  ...
  "ska": ["The Specials","Madness","Toots & The Maytals","Desmond Dekker","The Skatalites","The Selecter","Bad Manners","Hepcat","The Toasters","Reel Big Fish","Less Than Jake","The Mighty Mighty Bosstones","The Slackers","Operation Ivy","Streetlight Manifesto","Fishbone","Prince Buster","Laurel Aitken","Alton Ellis","Eastern Standard Time","La Mosca"],
  ...
  "thrashMetal": ["Metallica","Slayer","Megadeth","Anthrax","Exodus","Testament","Machine Head","Overkill","Sepultura","Kreator","Sodom","Destruction","Vio-Lence","Havok","Heathen","Annihilator","Death Angel","Forbidden","Municipal Waste","Tankard","Sacred Reich","Lost Society"],
  ...
  "trap": ["Bad Bunny","Anuel AA","Travis Scott","Future","Migos","Lil Baby","21 Savage","Young Thug","Playboi Carti","Lil Uzi Vert","Offset","Kodak Black","Roddy Ricch","DaBaby","Don Toliver","Ski Mask the Slump God","Gunna","NAV","Trippie Redd","YBN Nahmir","Trophyyy Boyyy"],
  "trapArgentino": ["Duki","Bizarrap","YSY A","Cazzu","Nicki Nicole","Trueno","Khea","Tiago PZK","Neo Pistea","Lit Killah","Ecko","Paulo Londra","Papo MC","Replik","Wos","FMK","Rusherking","Seven Kayne","C.R.O","Bhavi","Milo J"],
  "urbanoLatino": ["Bad Bunny","Karol G","Rauw Alejandro","Feid","Mora","Sech","Myke Towers","Natti Natasha","Becky G","Zion & Lennox","Anuel AA","Ozuna","Young Miko","María Becerra","Rels B","Lali","Tini","Micro TDH","Nathy Peluso","Jhayco","Kali Uchis","Big One","Mesita","Gente de Zona","Manuel Turizo","Arcángel","Yandel","Kevvo"],
