...
const artistsByGenre = {
  ...
  "balada": ["José José","Rocío Dúrcal","Camilo Sesto","Juan Gabriel","Cristian Castro","Luis Fonsi","Laura Pausini","Alejandro Sanz","Ana Gabriel","Ricardo Montaner","Vicente Fernández (baladas)","Yuri","Mijares","Chayanne","Emmanuel","Sandro","Myriam Hernández","Pablo Alborán","David Bisbal","Carlos Rivera","Silvina Garré","Dany Martin","Marcela Morelo","Pimpinela","Marco Antonio Solís"],
  ...
  "blues": ["B.B. King","Muddy Waters","Buddy Guy","Robert Johnson","Stevie Ray Vaughan","John Lee Hooker","Etta James","Eric Clapton","Howlin' Wolf","Joe Bonamassa"],
  "bluesRock": ["Javier Martínez (Manal)"],
  ...
  "cuarteto": ["Carlos 'La Mona' Jiménez","Rodrigo","Ulises Bueno","La Barra","Damián Córdoba","El Rey Pelusa","Walter Olmos","Banda XXI","Loco Amato","Sebastián","Tru-la-lá","Chebere","Gary","La Konga","Q' Lokura","Magui Olave","Monada","Jean Carlos","La Fiesta","La T y La M","Luck Ra"],
  ...
  "electronicaArgentina": ["Hernán Cattáneo","Peces Raros","Tremor","Javier Zuker","Ignacia"],
  "flamenco": ["Paco de Lucía","Camarón de la Isla","Vicente Amigo","Tomatito","Niño Josele"],
  "folk": ["Bob Dylan","Joan Baez","Simon & Garfunkel","Woody Guthrie","Neil Young","Cat Stevens","Joni Mitchell","Leonard Cohen","Peter, Paul and Mary","Nick Drake","Fairport Convention","The Byrds","Crosby, Stills & Nash","Donovan","James Taylor","Gordon Lightfoot","Odetta","Sufjan Stevens","Fleet Foxes","Iron & Wine","Tracy Chapman"],
  ...
  "folkloreColombia": ["Totó la Momposina"],
  "funkRap": ["Illya Kuryaki & the Valderramas"],
  ...
  "hardcorePunk": ["Black Flag","Minor Threat","Bad Brains","Dead Kennedys","Agnostic Front"],
  "heavyMetal": ["Iron Maiden","Judas Priest","Black Sabbath","Helloween","Manowar","Saxon","Accept","Van Halen","Whitesnake","Dio","Motörhead","Scorpions","Pantera","Metal Church","Yngwie Malmsteen","Stratovarius","Gamma Ray","Iced Earth","Primal Fear","DragonForce","Angra","Nightwish","Guns N' Roses"],
  ...
  "hiphop": ["Kendrick Lamar","Drake","J. Cole","Jay-Z","Kanye West","Travis Scott","Nicki Minaj","Cardi B","Wu-Tang Clan","Big Daddy Kane","Ice-T","EPMD","MC Hammer","Tyler, The Creator","A$AP Rocky","Run-DMC","LL Cool J","Rakim","Ice Cube","Public Enemy","Outkast","N.W.A.","Lil Wayne","Nas","50 Cent","ASD","Afrob","Samy Deluxe"],
  ...
  "infantil": ["Canticuénticos","Magdalena Fleitas","Los Raviolis","Pim Pau","Topa","Plim Plim","Diego Topa","Leoncito Alado","A Dormir, A Descansar Canciones Infantiles","A Dormir Plim Plim Canciones Infantiles","Canción de Cuna","Canción de La Familia Dedo","Cierro los Ojitos","La Lechuza Canciones Infantiles Para Dormir","Me Voy A Bañar Canciones Infantiles","Trenes, camiones y tractores"],
  "instrumental": ["Pablo Agri","Hilda Herrera","Franco Luciani","Daniel Maza","Manu Sija"],
  ...
  "popLatinoActual": ["Sebastián Yatra","Morat","Tini","Kany García","Carlos Rivera","Fonseca","Sin Bandera","Jesse & Joy","Camilo","Anahí","Maite Perroni","Samo","Leonel García","Lali","Fanny Lu","Sharon Corr (colab latinas)","Emilia","Valentino Merlo","Natti Natasha","CNCO","Piso 21","Greeicy","Gloria Trevi","Pedro Capó","Alex Ubago","Axel","Danny Ocean"],
  ...
  "rap": ["Eminem","Nas","Tupac","The Notorious B.I.G.","Lil Wayne","Ice Cube","Run-DMC","Rakim","Snoop Dogg","Jay-Z","Big L","DMX","J. Cole","Kendrick Lamar","Busta Rhymes","Big Pun","KRS-One","Tech N9ne","Killer Mike","Mos Def","Emanero"],
  "rb": ["Beyoncé","Rihanna","Usher","Alicia Keys","The Weeknd","Chris Brown","Mary J. Blige","SZA","Frank Ocean","Miguel","Ne-Yo","Trey Songz","Ciara","Brandy","Monica","Toni Braxton","Boyz II Men","Tyrese","Janelle Monáe","H.E.R.","Gnarls Barkley","Jesse Baez"],
  ...
  "reggaeton": ["Daddy Yankee","J Balvin","Karol G","Ozuna","Nicky Jam","Maluma","Feid","Rauw Alejandro","Anuel AA","Wisin & Yandel","Chencho Corleone","Ivy Queen","Don Omar","Farruko","Arcángel","De La Ghetto","Sech","Bryant Myers","Lunay","Tego Calderón","Gordo"],
  "rock": ["The Beatles","The Rolling Stones","Led Zeppelin","KISS","Santana","Creedence Clearwater Revival","Pink Floyd","Queen","The Who","AC/DC","Guns N' Roses","Aerosmith","U2","The Doors","Deep Purple","Bon Jovi","Pearl Jam","Radiohead","Coldplay","The Police","Dire Straits","Red Hot Chili Peppers","Chuck Berry","Little Richard","Buddy Holly","Elvis Presley","The Kinks","Van Morrison","Janis Joplin","Stevie Nicks","Alex Angel"],
  "rockArgentino": ["Soda Stereo","Charly García","Luis Alberto Spinetta","Fito Páez","Patricio Rey y sus Redonditos de Ricota","Los Redondos","Andrés Calamaro","Los Fabulosos Cadillacs","Divididos","Babasónicos","Los Auténticos Decadentes","Rata Blanca","Los Pericos","La Renga","Bersuit Vergarabat","Los Enanitos Verdes","Virus","Sumo","Los Tipitos","Catupecu Machu","Attaque 77","León Gieco","Pedro Aznar","David Lebón","Serú Girán","Los Abuelos de la Nada","Ratones Paranoicos","Todos Tus Muertos","Kapanga","Massacre","Carajo","Árbol","Eterna Inocencia","Gustavo Cerati","Eruca Sativa","Los Espíritus","Hilda Lizarazu","Dante Spinetta","Marilina Bertoldi","Conociendo Rusia","Los Piojos","Almendra","Pappo","Vox Dei","Color Humano","Billy Bond","Invisible","Manal","Arco Iris"],
  "rockLatino": ["Maná","Soda Stereo","Caifanes","Los Fabulosos Cadillacs","Molotov","Héroes del Silencio","Enanitos Verdes","Aterciopelados","Los Prisioneros","Café Tacuba","La Ley","Fito Páez","Charly García","Andrés Calamaro","Bersuit Vergarabat","La Renga","Divididos","Babasónicos","Rata Blanca","Los Auténticos Decadentes","Los Bunkers","Vicentico"],
  ...
  "vallenato": ["Carlos Vives","Fonseca"]
};
