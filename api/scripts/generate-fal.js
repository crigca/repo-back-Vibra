...
// Conceptos visuales abstractos (50% probabilidad de usar en lugar de escena)
const VISUAL_CONCEPTS = [
  // Abstracto musical
  "abstract visualization of sound waves",
  "flowing musical energy in space",
  "rhythm represented through geometric shapes",
  "vibrations and frequencies visualization",
  "sound particles floating",
  "musical notes morphing into colors",
  "audio spectrum display",

  // Close-ups de objetos
  "extreme close-up of instrument strings",
  "macro shot of vinyl record grooves",
  "speaker cone vibrating",
  "guitar pick frozen mid-strum",
  "drumstick hitting cymbal splash",
  "microphone mesh detail",
  "audio cable connectors",

  // Texturas y Materiales
  "layered textures representing sound layers",
  "fabric and materials music collage",
  "urban surfaces with music graffiti",
  "natural elements musical composition",
  "industrial metallic music surfaces",
  "worn leather and wood textures",

  // Conceptual sin personas
  "emotion expressed through pure color",
  "movement captured in abstract stillness",
  "energy radiating from center",
  "chaos and harmony visual balance",
  "raw musical expression",

  // Escenas vacías
  "empty stage before the concert",
  "abandoned recording studio atmosphere",
  "instruments resting in silence",
  "vinyl collection display",
  "music equipment scattered artistically",

  // Gráfico/Tipográfico
  "bold typography music poster",
  "minimalist icon design",
  "geometric abstraction of sound",
  "deconstructed instrument parts",
  "floating musical elements in void",

  // Experimental
  "intentional motion blur energy",
  "fragmented musical reality",
  "kaleidoscope of instruments",
  "time-lapse light painting music",
  "shattered vinyl explosion",
];
...
function buildPromptText(genre) {
  ...
  if (useAbstractConcept) {
    // Usar concepto visual abstracto
